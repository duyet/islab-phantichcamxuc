...
import preprocess.jvntagger.data.ContextGenerator;
import preprocess.jvntagger.data.Sentence;
import preprocess.jvntagger.data.StringUtils;
import preprocess.jvntagger.data.VnSyllParser;
...
public class POSContextGenerator extends ContextGenerator {
	...
	// Member variables
	//----------------------------------------------
	private static final String DEFAULT_E_DICT = "preprocess/jvntagger/ComputerDict.txt";
